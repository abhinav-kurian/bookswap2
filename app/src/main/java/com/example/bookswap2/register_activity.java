...
public class register_activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit1=findViewById(R.id.nameTextText);
        edit2=findViewById(R.id.usernameTextText);
        edit3=findViewById(R.id.passwordTextText);
    ...
    public void adduser(View v)
    {
        ...
        //print a toast
        Toast.makeText(register_activity.this,"NEW USER ADDED",Toast.LENGTH_LONG).show();
